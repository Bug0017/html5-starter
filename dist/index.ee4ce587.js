...
var _16 = require("@carbon/icons/es/add/16");
var _16Default = parcelHelpers.interopDefault(_16);
...
},{}],"i1fkr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "defaultAttributes", ()=>defaultAttributes
);
parcelHelpers.export(exports, "formatAttributes", ()=>formatAttributes
);
 ...
 */ function getAttributes() {
    ...
    }, width = _ref.width, height = _ref.height, _ref$viewBox = _ref.viewBox, viewBox = _ref$viewBox === void 0 ? "0 0 ".concat(width, " ").concat(height) : _ref$viewBox, attributes = _objectWithoutProperties(_ref, _excluded);
    var tabindex = attributes.tabindex, rest = _objectWithoutProperties(attributes, _excluded2);
    var iconAttributes = _objectSpread2(_objectSpread2(_objectSpread2({
    }, defaultAttributes), rest), {
    }, {
        width: width,
        height: height,
        viewBox: viewBox
 ...
 */ function toString(descriptor) {
    var _descriptor$elem = descriptor.elem, elem = _descriptor$elem === void 0 ? 'svg' : _descriptor$elem, _descriptor$attrs = descriptor.attrs, attrs = _descriptor$attrs === void 0 ? {
    } : _descriptor$attrs, _descriptor$content = descriptor.content, content = _descriptor$content === void 0 ? [] : _descriptor$content;
    var children = content.map(toString).join('');
    if (elem !== 'svg') return "<".concat(elem, " ").concat(formatAttributes(attrs), ">").concat(children, "</").concat(elem, ">");
 ...
 */ function toSVG(descriptor) {
    ...
    for(var i = 0; i < content.length; i++)node.appendChild(toSVG(content[i]));
    return node;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["3RuNK","85GYl"], "85GYl", "parcelRequiree764")
